package com.radiantbyte.nyxium.client.service
...
import com.radiantbyte.nyxium.client.game.AccountManager
import com.radiantbyte.nyxium.client.game.GameSession
import com.radiantbyte.nyxium.client.game.ModuleManager
import com.radiantbyte.nyxium.client.model.CaptureModeModel
import com.radiantbyte.nyxium.client.overlay.OverlayManager
    ...
    private fun on(context: Context, captureModeModel: CaptureModeModel) {
        ...
        this.thread = thread(
            ...
            runCatching {
                ...
                it.printStackTrace()
                context.toast("Start NyxiumRelay error: ${it.stackTraceToString()}")
            }
